...
![](reference/figures/quiz-description.png)
...
![](reference/figures/quiz-cloze.png)
...
![](reference/figures/quiz-essay.png)
...
![](reference/figures/quiz-multichoice.png)
...
![](reference/figures/moodle-question-bank.png)

Import questions by selecting “Import” from the drop-down.

![](reference/figures/moodle-dropdown-import.png)
...
![](reference/figures/moodle-question-import.png)
...
![](reference/figures/moodle-import-success.png)
...
![](reference/figures/moodle-from-bank.png)
...
![](reference/figures/moodle-import-bank.png)

Your questions are now added to the quiz! 🎉

![](reference/figures/moodle-question-success.png)
